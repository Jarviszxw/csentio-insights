(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_33a46b19._.js", {
...
async function fetchTotalGMV(dateRange) {
    try {
        ...
        console.error('Error fetching total GMV:', error);
        // 返回默认值
        return {
            total_gmv: 1250,
            mom_percentage: 12.5,
        ...
        "SectionCards.useEffect": ()=>{
            async function loadGMVData() {
                ...
                try {
                    ...
                    console.error("Failed to load GMV data:", error);
                } finally{
                    setIsLoading(false);
                }
            }
...
_s(SectionCards, "640RbwTC8e6DvL/3db0cFmD3EiI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$date$2d$range$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDateRange"]
    ];
});
...
//# sourceMappingURL=_33a46b19._.js.map